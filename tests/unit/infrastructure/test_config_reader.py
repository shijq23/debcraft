...
@pytest.mark.unit
@pytest.mark.mirror
class TestConfigReaderRateLimitValidation:
    """When rate-limit config values are invalid, raises MirrorConfigurationError."""

    def test_non_numeric_rate_limit_rps_raises_error(self, tmp_path: Path) -> None:
        toml_content = """\
[settings]
rate_limit_rps = "fast"
...
"""
    ...
    def test_non_numeric_rate_limit_burst_raises_error(self, tmp_path: Path) -> None:
        toml_content = """\
[settings]
...
"""
    ...
    def test_rate_limit_rps_below_minimum_raises_error(self, tmp_path: Path) -> None:
        toml_content = """\
[settings]
rate_limit_rps = 0.5
...
"""
        ...
        error_msg = str(exc_info.value)
        assert "rate_limit_rps" in error_msg
        assert "1" in error_msg and "1000" in error_msg

    def test_rate_limit_rps_above_maximum_raises_error(self, tmp_path: Path) -> None:
        toml_content = """\
[settings]
rate_limit_rps = 1500
...
"""
    ...
    def test_rate_limit_burst_below_minimum_raises_error(self, tmp_path: Path) -> None:
        toml_content = """\
[settings]
rate_limit_burst = 0
...
"""
        ...
        error_msg = str(exc_info.value)
        assert "rate_limit_burst" in error_msg
        assert "1" in error_msg and "200" in error_msg

    def test_rate_limit_burst_above_maximum_raises_error(self, tmp_path: Path) -> None:
        toml_content = """\
[settings]
...
"""
    ...
    def test_valid_rate_limit_rps_integer_accepted(self, tmp_path: Path) -> None:
        toml_content = """\
[settings]
rate_limit_rps = 100
...
"""
    ...
    def test_valid_rate_limit_rps_float_accepted(self, tmp_path: Path) -> None:
        toml_content = """\
[settings]
rate_limit_rps = 25.5
...
"""
        ...
        assert config.rate_limit_rps == 25.5

    def test_valid_rate_limit_burst_accepted(self, tmp_path: Path) -> None:
        toml_content = """\
[settings]
rate_limit_burst = 50
...
"""
    ...
    def test_boolean_rate_limit_rps_raises_error(self, tmp_path: Path) -> None:
        toml_content = """\
[settings]
rate_limit_rps = true
