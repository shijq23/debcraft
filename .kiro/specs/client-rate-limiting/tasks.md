...
- [x] 2. Implement TokenBucketRateLimiter
  ...
  - [x] 2.4 Write property test for token bucket replenishment (Property 1)
  ...
  - [x] 2.5 Write property test for acquire blocking and timeout (Property 2)
  ...
  - [x] 2.6 Write property test for maximum request rate enforcement (Property 3)
...
- [x] 4. Extend ConfigReader to parse rate-limit settings
  ...
  - [x] 4.4 Write property test for config parsing round-trip (Property 4)
  ...
  - [x] 4.5 Write property test for config validation rejection (Property 5)
...
- [x] 5. Integrate rate limiter and 403 retry into DownloadCoordinator
  - [x] 5.1 Modify `DownloadCoordinator.__init__` to accept rate limiter
    - Add optional `rate_limiter: TokenBucketRateLimiter | None = None` parameter
    - Store as `self._rate_limiter`
    - _Requirements: 4.1_

  - [x] 5.2 Add rate limiter acquire call in `_attempt_download`
  ...
  - [x] 5.3 Reclassify HTTP 403 as `HttpRateLimitError`
  ...
  - [x] 5.4 Update retry loop to handle `HttpRateLimitError` with extended backoff
  ...
  - [x] 5.5 Update `close()` and `download_batch` for rate limiter lifecycle
  ...
  - [x] 5.6 Write property test for 403 retry behavior (Property 6)
  ...
  - [x] 5.7 Write property test for exhausted 403 retries (Property 7)
  ...
  - [x] 5.8 Write property test for successful 403 retry (Property 8)
  ...
  - [x] 5.9 Write property test for .part file cleanup on 403 (Property 9)
  ...
  - [x] 5.10 Write property test for 403 backoff delay bounds (Property 10)
  ...
  - [x] 5.11 Write property test for rate limiter acquire call count (Property 11)
